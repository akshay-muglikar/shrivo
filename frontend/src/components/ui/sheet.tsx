    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          fullScreen && "inset-0 h-screen w-screen max-w-none rounded-none data-[side=left]:left-0 data-[side=left]:right-0 data-[side=left]:w-screen data-[side=left]:h-screen data-[side=right]:left-0 data-[side=right]:right-0 data-[side=right]:w-screen data-[side=right]:h-screen data-[side=top]:top-0 data-[side=top]:bottom-0 data-[side=top]:h-screen data-[side=bottom]:top-0 data-[side=bottom]:bottom-0 data-[side=bottom]:h-screen",
          className
        )}
        {...props}
      >
